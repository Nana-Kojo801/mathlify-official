...
const CasualSettings = () => {
  const casualForm = useForm<z.infer<typeof practiceCasualSchema>>({
  ...
  const startCasualPractice = (
    values: z.infer<typeof practiceCasualSchema>
  ) => {
    init(values);
    navigate("/app/practice/casual");
  };
  return (
    <Form {...casualForm}>
      <form
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input {...field} placeholder="From" className="bg-gray-700" type="number" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input {...field} placeholder="To" className="bg-gray-700" type="number" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input {...field} placeholder="Min" className="bg-gray-700" type="number" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input {...field} placeholder="Max" className="bg-gray-700" type="number" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
